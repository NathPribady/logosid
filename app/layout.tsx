    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">About Logos ID</h3>
            <p className="text-gray-400">
              Empowering minds through education. We provide high-quality educational content, webinars, and podcasts.
            </p>
          </div>
          <div>
